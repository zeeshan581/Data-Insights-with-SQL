...
2. **Feature Engineering**
   - Extracted behavioral features: transaction frequency, amount, distance, and time intervals  

3. **Modeling**
   - Trained Random Forest and Logistic Regression models  
   - Achieved **96% recall** for fraud detection  
...
## 📬 Contact
**Author:** MD Zeeshan Hassan  
🔗 [LinkedIn](https://linkedin.com/in/yourprofile) | 🐙 [GitHub](https://github.com/zeeshan581)
